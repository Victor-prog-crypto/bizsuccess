  ...
  if (
    ...
    const errorMessage =
      referencedApps.length > 0
        ? "Referencing other apps (@app:Name) in local-agent mode requires Bizsaas Pro. Please enable Bizsaas Pro in Settings → Pro."
        : "Agent v2 requires Bizsaas Pro. Please enable Bizsaas Pro in Settings → Pro.";
