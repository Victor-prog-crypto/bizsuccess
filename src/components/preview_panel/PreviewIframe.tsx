    ...
    >
      ...
      {(isInternalDyadError || isSyncError) && (
        <div className="absolute top-1 right-1 p-1 bg-red-100 dark:bg-red-900 rounded-md text-xs font-medium text-red-700 dark:text-red-300">
          {isSyncError ? "Cloud sync issue" : "Internal Bizsaas error"}
        </div>
      )}
        ...
        <div className="relative p-2 bg-red-100 dark:bg-red-900 rounded-sm flex gap-1 items-center">
          ...
          <span className="text-sm text-red-700 dark:text-red-200">
            ...
            {isDockerError
              ...
              : isSyncError
                ? "Bizsaas could not upload your latest local changes to the cloud sandbox. Check your network connection or wait for sync to recover."
                : isInternalDyadError
                  ? "Try restarting the Bizsaas app or restarting your computer to see if that fixes the error."
    ...
    if (
      ...
      setErrorMessage({
        message: cloudSandboxStatus.lastErrorMessage
          ? cloudSandboxStatus.lastErrorMessage.includes("Bizsaas stopped")
            ? cloudSandboxStatus.lastErrorMessage
            : cloudSandboxStatus.terminationReason === "credits_exhausted"
              ? "This cloud sandbox was stopped because your Bizsaas Pro credits ran out. Add credits and start it again."
              : "This cloud sandbox was stopped because Bizsaas could not confirm billing. Please try starting it again."
          : cloudSandboxStatus.terminationReason === "credits_exhausted"
            ? "This cloud sandbox was stopped because your Bizsaas Pro credits ran out. Add credits and start it again."
            : "This cloud sandbox was stopped because Bizsaas could not confirm billing. Please try starting it again.",
        source: "dyad-app",
