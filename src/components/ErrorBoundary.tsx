...
`;
      ...
      const encodedTitle = encodeURIComponent(
        "[bug] Error in Bizsaas application",
      );
      const githubIssueUrl = `https://github.com/Victor-prog-crypto/bizsuccess/issues/new?title=${encodedTitle}&labels=bug,filed-from-app,client-error&body=${encodedBody}`;
      ...
      ipc.system.openExternalUrl("https://github.com/Victor-prog-crypto/bizsuccess/issues/new");
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="max-w-md w-full bg-background p-6 rounded-lg shadow-lg">
        ...
        <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-md flex items-center gap-2">
          ...
          <p className="text-sm text-blue-700 dark:text-blue-400">
            <strong>Tip:</strong> Try closing and re-opening Bizsaas as a temporary
            workaround.
          </p>
        </div>
      </div>
