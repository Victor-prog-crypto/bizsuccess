  ...
  return (
    <Popover>
      <Tooltip>
        ...
        <TooltipContent>Configure Bizsaas Pro settings</TooltipContent>
      </Tooltip>
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            <h4 className="font-medium flex items-center gap-1.5">
              ...
              <span className="text-primary font-medium">Bizsaas Pro</span>
            </h4>
          ...
          <div className="flex flex-col gap-3">
            <SelectorRow
              id="pro-enabled"
              label="Enable Bizsaas Pro"
              tooltip="Uses Bizsaas Pro AI credits for the main AI model and Pro modes."
                ...
                <AccordionContent className="pb-3">
                  <div className="flex flex-col gap-5 pt-2">
                    <SelectorRow
                      id="web-search"
                      label="Web Access"
                      tooltip="Allows Bizsaas to access the web (e.g. search for information)"
